                        ...
                        <form method="post" action="{{ route('questions.store') }}" class="card-body">
                            ...
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" type="text" name="title" placeholder="e.g. How to fullstack in 1 week with thousand dollars salary ?">
                                </div>
                            </div>
                            <div class="input-box">
                                ...
                                @endif
                                <div class="form-group">
                                    <textarea class="form-control form--control" name="body" rows="10" cols="40" placeholder="How to build a snowman ?"></textarea>
                                </div>
                            </div>
            ...
            <div class="row pt-50px">
                <div class="col-lg-4 responsive-column-half">
                    <div class="card card-item hover-y text-center">
                        <div class="card-body">
                            <img src="{{ asset('images/bubble.png') }}" alt="bubble">
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="card card-item hover-y text-center">
                        <div class="card-body">
                            <img src="{{ asset('images/vote.png') }}" alt="vote">
