...
@section('content')
    <section class="sign-up-area pt-80px pb-80px position-relative">
        <div class="container">
                ...
                <div class="card-body row p-0">
                    <div class="col-lg-6">
                        <div class="form-content py-4 pr-60px pl-60px border-right border-right-gray h-100 d-flex align-items-center justify-content-center">
                            <img src="{{ asset('images/undraw-remotely.svg') }}" alt="Image" class="img-fluid">
                        </div>
                    </div><!-- end col-lg-6 -->
                            ...
                            <div class="form-group">
                                <div class="d-flex align-items-center">
                                    <div class="custom-control custom-checkbox fs-13 mr-4">
                                        ...
                                        <label class="custom-control-label custom--control-label lh-18" for="opt-in">Opt-in to receive occasional product updates, user research invitations, company announcements, and digests.</label>
                                    </div>
            ...
            <p class="text-black text-center fs-15">Already have an account? <a href="{{ route('user.login.page') }}" class="text-color hover-underline">Log in</a></p>
        </div><!-- end container -->
